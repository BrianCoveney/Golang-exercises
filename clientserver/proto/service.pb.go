...
func init() {
	proto.RegisterType((*Request)(nil), "clientserver.Request")
...
func (c *reverseClient) Do(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := grpc.Invoke(ctx, "/clientserver.Reverse/Do", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Reverse_Do_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clientserver.Reverse/Do",
	}
...
var _Reverse_serviceDesc = grpc.ServiceDesc{
	ServiceName: "clientserver.Reverse",
...
var fileDescriptor0 = []byte{
	...
	0xcb, 0x4c, 0x4e, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x49, 0xce, 0xc9, 0x4c, 0xcd,
	0x2b, 0x01, 0x09, 0xa6, 0x16, 0x29, 0x29, 0x73, 0xb1, 0x07, 0xa5, 0x16, 0x96, 0xa6, 0x16, 0x97,
	0x08, 0x49, 0x70, 0xb1, 0xe7, 0xa6, 0x16, 0x17, 0x27, 0xa6, 0xa7, 0x4a, 0x30, 0x2a, 0x30, 0x6a,
	0x70, 0x06, 0xc1, 0xb8, 0x4a, 0x2a, 0x5c, 0x1c, 0x41, 0xa9, 0xc5, 0x05, 0xf9, 0x79, 0xc5, 0xa9,
	0xb8, 0x55, 0x19, 0x39, 0x80, 0x8c, 0x2a, 0x4b, 0x2d, 0x2a, 0x4e, 0x15, 0x32, 0xe5, 0x62, 0x72,
	0xc9, 0x17, 0x12, 0xd5, 0x43, 0xb6, 0x4a, 0x0f, 0x6a, 0x8f, 0x94, 0x18, 0xba, 0x30, 0xc4, 0x64,
	0x25, 0x86, 0x24, 0x36, 0xb0, 0x0b, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xd9, 0xf6, 0xfa,
